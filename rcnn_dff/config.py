...
config.EMBEDDING_PARAMS_LIST = ['embedding_conv1_weight','embedding_conv1_bias','embedding_conv2_weight','embedding_conv2_bias','embedding_conv3_weight', 'embedding_conv3_bias']
...
config.FLOW_SCALE_FACTOR = 0.00392156862745098 # 0.00392156
config.FLOW_LOSS_SCALE = {'loss1': 1.00,
                          'loss2': 0.00,
                          'loss3': 0.00,
                          'loss4': 0.00,
                          'loss5': 0.00,
