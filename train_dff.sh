...
python train_end2end_dff.py --dataset Kitti --gpu 6,7 --image_set train --dataset_path data/kitti --prefix model/e2e-non-fix-flow --end_epoch 21 --pretrained model/e2e-fix-flow-anchorloader-train --pretrained_epoch 22
