...
python train_end2end_dff.py --dataset Kitti --gpu  4,5 --image_set train --dataset_path data/kitti --prefix /data/syzhang/rcnn_dff/model/e2e-ffa-new-k2 --end_epoch 15 --pretrained /data/syzhang/model/e2e-rcnn-log --pretrained_epoch 10
