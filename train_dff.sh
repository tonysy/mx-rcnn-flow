...
python train_end2end_dff.py --dataset Kitti --gpu 6,7 --image_set train --dataset_path data/kitti --prefix /data/syzhang/rcnn_dff/model/e2e-non-fix-flow-anchor2 --end_epoch 35 --pretrained /data/syzhang/rcnn_dff/model/vgg16 --pretrained_epoch 1
