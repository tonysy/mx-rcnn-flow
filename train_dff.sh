...
python train_end2end_dff.py --dataset Kitti --gpu  6 --image_set train --dataset_path data/kitti --prefix /data/syzhang/rcnn_dff/model/e2e-ffa --end_epoch 35 --pretrained /data/syzhang/rcnn_dff/model/vgg16 --pretrained_epoch 1
